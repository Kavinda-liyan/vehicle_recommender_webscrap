...
def parse_vehicle_title(title):
    ...
    return {"Manufacturer": manufacturer, "Model": model, "Year": year, "Condition": condition,"Fuel Type":"Diesel"}


#Web Scraper
base_url = "https://ikman.lk/en/ads/sri-lanka/cars?enum.fuel_type=diesel"
page = 1
diesel_vehicles = []
